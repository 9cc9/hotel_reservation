...
module Service
  describe ChargeService do
    before do
      ...
      @service = ChargeService.new(@controller)
    end
    ...
    describe '#get_cheapest_hotel' do
      context 'when 3 days all weekdays' do
        ...
        it 'get cheapest hotel is Lakewood' do
          @service.get_cheapest_hotel(@parameter).should eq :Lakewood
        end
      end
      ...
      context 'when regular custom has 2 of 3 days is weekends' do
        ...
        it 'get cheapest hotel is Lakewood' do
          @service.get_cheapest_hotel(@parameter).should eq :Bridgewood
        end
      end
      ...
      context 'when rewards custom has 2 of 3 days is weekends' do
        ...
        it 'get cheapest hotel is Lakewood' do
          @service.get_cheapest_hotel(@parameter).should eq :Ridgewood
        end
      end
    end
  end
